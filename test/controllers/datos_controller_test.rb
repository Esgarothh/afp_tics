...
class DatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dato" do
    assert_difference('Dato.count') do
      post datos_url, params: { dato: { apellido: @dato.apellido, edad: @dato.edad, email: @dato.email, nombre: @dato.nombre } }
    end
  ...
  test "should update dato" do
    patch dato_url(@dato), params: { dato: { apellido: @dato.apellido, edad: @dato.edad, email: @dato.email, nombre: @dato.nombre } }
