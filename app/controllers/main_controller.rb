class MainController < ApplicationController
  ...
  def index
    ...
    @tasaInteres = 0.0366  #tasa de interes fija
    @sum  ,dor = 0 
    ...
    #tablas de mortalidad en formato array 
    if params[:nombre] != nil
      #parametros recibidos POST de formulario
      ...
      #EDAD MAXIMA 40 AÑOS
      #A=6,52%, B=6,58%, C=7,35%, D=4,14 E=4.11 valores fijos de rentabilidad
      @devEstA = 0.0783    #variacion estandar de rentablidad para cada fondo
      @devEstB = 0.0256    # usado para los escenarios optimistas y pesimistas
      @devEstC = 0.0073
      @devEstD = 0.0064
      @devEstE = 0.0019
      @RentaA = 1.0502
      ...
      if params[:experto] == 'Si'   #operador logico en caso de rentabilidad especifica
      ...
      #asignacion de las rentabilidades segun el fondos seleccionado
      ...
      while count <= @T
        ...
        #Valor CNU fiel a la formula original estadistica
        count+=1
        end
      ...
      @ahorradoEsperado = plataTotalEsperado    #Ahorros totales con rentabilidad promedio
      @ahorradoOptimista = plataTotalOptimista  #Ahorros totales con rentabilidad optimista
      @ahorradoPesimista = plataTotalPesimista  #Ahorros totales con rentabilidad pesimista
      ...
      #ingenieria inversa para conseguir APV necesaria segun sueldo sugerido
